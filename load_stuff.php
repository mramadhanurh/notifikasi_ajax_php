...
if(isset($_SESSION["user_id"]))
{
    ...
    SELECT content.content_id, content.user_id, content.description,
        user_details.user_name, user_details.user_image FROM content
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">
                        <img src="images/'.$row["user_image"].'" class="img-thumbnail" width="40" height="40" > By '.$row["user_name"].'
                    </h3>
    ...
    {
        $output = 'Tidak ada yang tidak berbagi apa-apa';
    }
    echo $output;
}
